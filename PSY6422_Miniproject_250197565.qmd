...
The paper cites previous research that has shown that mental and physical well-being are positively affected by the spending time out in nature, along with social identity and support.
...
Using the data set from the above paper, this mini-project will attempt to visualize the relationship between mental health, time spent in nature, and connection to nature, and any potential differences in men and women, and attempt to answer the question — 'Does time spent in nature improve mental health, and does the connection felt to nature influence this?'
...
The dataset was not particularly large, with only a little over 500 participants; a larger data sample would have helped to come to a more accurate conclusion. A regression analysis would have provided accurate significance and correlation values and the degree to which any moderating factors effect the scores to make a detailed conclusion. If provided with more time, learning to perform a regression analysis on R studio would be the preferred next step.
